...
This directory is ignored except for this file. Generate the two matching
Cobalt key files and the independent stable Anubis Ed25519 signing key with:

```sh
node scripts/init-secrets.mjs
```

The generator sets this directory to mode `0700` and the three files to mode
